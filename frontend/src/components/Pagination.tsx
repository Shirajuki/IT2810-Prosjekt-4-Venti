...
function Pagination () {
            ...
            return (<View style={styles.wrapper}>
				{CTX.fetchStore.currentPage > 0 ? <TouchableOpacity style={styles.text} onPress={() => CTX.fetchStore.setCurrentPage(CTX.fetchStore.currentPage -= 1)}><Text>Previous</Text></TouchableOpacity> : null}
				...
				{CTX.fetchStore.currentPage != CTX.fetchStore.pageCount - 1? (<TouchableOpacity style={styles.text} onPress={() => CTX.fetchStore.setCurrentPage(CTX.fetchStore.currentPage += 1)}>Next</TouchableOpacity>) : null}
				</View>);
}
